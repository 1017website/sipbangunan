...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .nav-wa:hover {
            background: var(--y2);
            box-shadow: 0 4px 14px rgba(251, 191, 0, .4);
        }
        ...
        .ccard:hover {
            ...
            box-shadow: 0 12px 32px rgba(251, 191, 0, .15);
        }
        ...
        .ccard:hover .cc-name,
        .ccard:hover .cc-count,
        .ccard:hover .cc-desc,
        .ccard:hover .cc-arrow {
            color: var(--ink);
        }
        ...
        .wcard:hover {
            border-color: var(--y);
            box-shadow: 0 6px 20px rgba(251, 191, 0, .1);
        }
        ...
        .list-body-wrap {
            max-width: 1280px;
            margin: 0 auto;
            padding: 28px max(24px, 4vw) 80px;
        }
        ...
        .pcard:hover {
            border-color: var(--y);
            box-shadow: 0 8px 28px rgba(251, 191, 0, .12);
            transform: translateY(-3px);
        }

        .pcard-thumb {
            height: 150px;
            background: linear-gradient(135deg, var(--y4) 0%, var(--y3) 100%);
            display: flex;
            align-items: center;
            justify-content: center;
            font-size: 3.5rem;
        ...
        .detail-body {
            max-width: 1180px;
            margin: 0 auto;
            padding: 32px max(24px, 4vw) 80px;
        }
        ...
        .d-img-panel {
            background: linear-gradient(160deg, var(--y4) 0%, var(--y3) 100%);
            border: 1px solid var(--y3);
            border-radius: var(--radius-lg);
            height: 360px;
            display: flex;
        ...
        .d-spec-tbl tr:last-child td {
            border-bottom: none;
        }

        .d-spec-tbl td:first-child {
            color: var(--muted);
            font-weight: 500;
            width: 45%;
        }

        .d-spec-tbl td:last-child {
            color: var(--ink);
            font-weight: 600;
        }

        .d-buy-card .d-card-pad {
            display: flex;
            flex-direction: column;
            gap: 8px;
        }
        ...
        .wa-float {
            ...
            transition: all .22s;
            animation: wf 2.5s ease-in-out infinite;
        }
