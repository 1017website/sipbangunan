        ...
        <div class="contact-grid">
            <div class="contact-info-card">
                ...
                <div class="cic-body">
                    ...
                    <div class="ci"><div class="ci-ico">📞</div><div><div class="ci-lbl">Telepon / WhatsApp</div><div class="ci-val"><a href="tel:{{ $cPhone }}">{{ $cPhone ?: '-' }}</a></div></div></div>
                    <div class="ci"><div class="ci-ico">⏰</div><div><div class="ci-lbl">Jam Operasional</div><div class="ci-val">{{ $settings['hours'] ?? '-' }}</div></div></div>
                    <div class="ci"><div class="ci-ico">✉️</div><div><div class="ci-lbl">Email</div><div class="ci-val"><a href="mailto:{{ $cEmail }}">{{ $cEmail ?: '-' }}</a></div></div></div>
                </div>
                <div class="cic-foot">
