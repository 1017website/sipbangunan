                ...
                <div class="cic-foot">
                    ...
                    <div class="soc-row">
                        @if(!empty($settings['tokped_url']))
                            <a href="{{ $settings['tokped_url'] }}" target="_blank" class="soc-btn">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M17.5 3H6.5C4.567 3 3 4.567 3 6.5v11C3 19.433 4.567 21 6.5 21h11c1.933 0 3.5-1.567 3.5-3.5v-11C21 4.567 19.433 3 17.5 3z" fill="#42B549"/><path d="M12 7v10M7 12h10" stroke="#fff" stroke-width="2" stroke-linecap="round"/></svg>
                                Tokopedia
                            </a>
                            @endif
                            @if(!empty($settings['shopee_url']))
                            <a href="{{ $settings['shopee_url'] }}" target="_blank" class="soc-btn">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="#EE4D2D"><path d="M19 7h-1.5A5.5 5.5 0 006.5 7H5a2 2 0 00-2 2l1 11a2 2 0 002 2h12a2 2 0 002-2l1-11a2 2 0 00-2-2zm-7-3.5A3.5 3.5 0 0115.5 7h-7A3.5 3.5 0 0112 3.5z"/></svg>
                                Shopee
                            </a>
                            @endif
                            @if(!empty($settings['tiktok_url']))
                            <a href="{{ $settings['tiktok_url'] }}" target="_blank" class="soc-btn">
                            ...
                            <a href="{{ $settings['facebook_url'] }}" target="_blank" class="soc-btn">
                            ...
                            <a href="{{ $settings['instagram_url'] }}" target="_blank" class="soc-btn">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="url(#ig)"><defs><linearGradient id="ig" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stop-color="#F58529"/><stop offset="50%" stop-color="#DD2A7B"/><stop offset="100%" stop-color="#8134AF"/></linearGradient></defs><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
                                Instagram
                            </a>
                        @endif
                    </div>
