            ...
            <div class="d-info-panel">
                ...
                <div class="d-card">
                    <div class="d-card-pad" style="padding-bottom:0;padding-top:16px;">
                        <div style="font-size:.68rem;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:var(--light);margin-bottom:8px;">Spesifikasi</div>
                    </div>
                ...
                <div class="d-card d-buy-card">
                    <div class="d-card-pad">
                        <div style="font-size:.68rem;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:var(--light);margin-bottom:12px;">Beli Sekarang Di</div>
                        @if($product->tokped_url)
                        <a href="{{ $product->tokped_url }}" target="_blank" class="buy-btn bb-tokped">
                            <div class="bico">🛒</div>
                            <div><div class="bname">Tokopedia</div><div class="bsub">Lihat & beli di Tokopedia</div></div>
                        ...
                        <a href="{{ $product->shopee_url }}" target="_blank" class="buy-btn bb-shopee">
                            <div class="bico">🛍</div>
                            <div><div class="bname">Shopee</div><div class="bsub">Lihat & beli di Shopee</div></div>
                            <span class="barr">→</span>
                        </a>
                        @endif
                        ...
                        <a href="{{ $product->tiktok_url }}" target="_blank" class="buy-btn bb-tiktok">
                            <div class="bico">▶</div>
                            <div><div class="bname">TikTok Shop</div><div class="bsub">Tonton & beli di TikTok</div></div>
                            <span class="barr">→</span>
                        </a>
                        @endif
                        <a href="https://wa.me/{{ $settings['wa_number'] ?? '6281234567890' }}?text={{ urlencode($product->wa_text ?? 'Halo, saya ingin bertanya tentang ' . $product->name) }}" target="_blank" class="buy-btn bb-wa">
                            <div class="bico">💬</div>
                            <div><div class="bname">WhatsApp</div><div class="bsub">Tanya harga & stok langsung</div></div>
                            <span class="barr">→</span>
                        </a>
                    </div>
                </div>
